...
# Hardcoded topics data for Step 1
TOPICS_DATA = {
    "Algebra": ["Linear Equations", "Quadratics", "Polynomials", "Systems of Equations", "Inequalities", "Functions", "Sequences & Series", "Exponents & Logarithms"],
    "Geometry": ["Triangles", "Circles", "Polygons", "Coordinate Geometry", "3D Geometry", "Trigonometry", "Transformations"],
    "Number Theory": ["Divisibility", "Primes & Factors", "Modular Arithmetic", "Diophantine Equations", "Number Bases"],
    "Combinatorics": ["Counting Principles", "Permutations & Combinations", "Probability", "Binomial Theorem", "Pigeonhole Principle", "Graph Theory"],
    "Mixed": ["Logic Puzzles", "Pattern Finding", "Miscellaneous"]
}
